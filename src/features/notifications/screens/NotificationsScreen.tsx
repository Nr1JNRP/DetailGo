...
import { ArrowLeft, Bell, CalendarCheck } from 'lucide-react-native';
...
export default function NotificationsScreen() {
  ...
  // Ao abrir, marca todas como lidas (zera o badge do sino).
  useEffect(() => {
    if (!shopId) return;
    markAllNotificationsRead(shopId).catch(() => {});
  }, [shopId]);
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerText}>
            ...
            <Text style={styles.headerSub}>Agendamentos recebidos</Text>
          </View>
        </View>
  ...
  return (
    <View style={[styles.row, !item.read && styles.rowUnread]}>
      <View style={styles.rowIcon}>
        <CalendarCheck size={18} color={D.primary} strokeWidth={2.1} />
      </View>
